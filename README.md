...
> **Note on the name:** This project does not currently retrieve from an external knowledge base — there's no document store, embeddings, or vector search yet. Both buttons are general-purpose chat backends. See [Roadmap](#roadmap) if you want to add real retrieval-augmented generation.
...
**Memory note:** loading DialoGPT-medium plus PyTorch typically needs 1–2GB of RAM. 
